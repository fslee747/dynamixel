...
ADDR_MX_BAUDRATE            = 1                 # Control table address is different in Dynamixel model
...
FACTORYRST_DEFAULTBAUDRATE  = 1000000             # Dynamixel baudrate set by factoryreset  出廠設置設置的動態像素波特率
NEW_BAUDNUM                 = 1                 # New baudnum to recover Dynamixel baudrate as it was 新的baudnum恢復動態像素波特率
OPERATION_MODE              = 0x00              # Mode is unavailable in Protocol 1.0 Reset 協議1.0重置中無法使用模式
